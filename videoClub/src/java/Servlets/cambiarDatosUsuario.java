...
public class cambiarDatosUsuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.print(idUsuario + nombre + direccion + clave + correo + telefono);
            Class.forName("com.mysql.jdbc.Driver");
            ConnexionMySQL cn = new ConnexionMySQL();
            cn.obtenerConexion();
            cn.cambiarDatos(idUsuario, nombre, direccion, clave, correo, telefono);
            cn.desconectar();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(cambiarDatosUsuario.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
