 ...
 * @author alvaro
 */
public class FiltroPeliculas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            String seleccion = request.getParameter("genero");
            ...
            request.setCharacterEncoding("UTF-8");
                ...
                try {
                    ...
                    cn.obtenerConexion();
                    datosPelicula = cn.listarPeliculasGenero(seleccion);
                    request.setAttribute("lasPeliculas", datosPelicula);
                    //Preparamos para enviar a Inicio.jsp
                    RequestDispatcher myDispatcher = request.getRequestDispatcher("./Peliculas.jsp");
