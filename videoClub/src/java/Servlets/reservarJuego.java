 ...
 * @author alvaro
 */
public class reservarJuego extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String nomJuego=(String)request.getParameter("nomJuego");
            ...
            try {
                ...
                cn.reservarJuego(id_Us, id_Peli,nomJuego,imagen, fecha, estado, precio, descuento);
                out.print("Id_US" + id_Us + "id-peli" + id_Peli + "nombre"+ nomJuego+ "fecha" + fecha + "estado" + estado + "precio" + precio + "descuento" + descuento);
                cn.desconectar();
                response.sendRedirect("cargaJuego");
