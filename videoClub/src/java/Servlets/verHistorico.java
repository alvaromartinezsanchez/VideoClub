 ...
 * @author alvaro
 */
public class verHistorico extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                cn.obtenerConexion();
                listaReservas = cn.listarTodasReservas();
                request.setAttribute("lasReservas", listaReservas);
                //Preparamos para enviar a Inicio.jsp
                RequestDispatcher myDispatcher = request.getRequestDispatcher("./Historico.jsp");
