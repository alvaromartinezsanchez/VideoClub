...
public class datosUsuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            cn.obtenerConexion();
            user = cn.listarUsuarios(id);
            request.setAttribute("UsuarioList", user);
            
            //Preparamos para enviar a Inicio.jsp
                RequestDispatcher myDispatcher = request.getRequestDispatcher("./verUsuario.jsp");
