<%-- 
    Document   : index
    Created on : 24-feb-2020, 11:28:38
    Author     : alvaro
--%>
        ...
        <div class="container">
            <header class="row justify-content-center">
                ...
                <ul class="nav nav-pills nav-fill">
                    <li class="nav-item">
                        <a class="btn col" href="index2.jsp"  role="button"  class="nav-link active">Iniciar Sesion</a>
                    </li>
                    <li class="nav-item">
                        <a class="btn col" href="registrarUsuarios.jsp"  role="button" >Registro Usuario</a>
                    </li>
